        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServerIds = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Title = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    PublisherId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublisherId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    AddedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ServerType = table.Column<int>(type: "int", nullable: true),
                    IPAddress = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    LastLiveOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ActiveTimeStart = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ActiveTimeEnd = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PeakConcurrentUsers = table.Column<int>(type: "int", nullable: true),
